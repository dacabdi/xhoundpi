...
from .coordinate_offset import CoordinateOffset, ICoordinateOffsetProvider
...
class NMEAOffsetOperator(IMessageOperator):
    ...
    def __common(self, message: Message, offset: CoordinateOffset) -> Dict[str, str]:
    ...
    def __optional(self, message: Message, offset: CoordinateOffset) -> Dict[str, str]:
        nmea = message.payload
        result = {}
        if hasattr(nmea, 'alt'):
...
class UBXOffsetOperator(IMessageOperator):
    ...
    def __common(self, message: Message, offset: CoordinateOffset) -> Dict[str, Any]:
        ubx = message.payload
    ...
    def __optional(self, message: Message, offset: CoordinateOffset) -> Dict[str, Any]:
        ubx = message.payload
        result = {}
